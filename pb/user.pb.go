...
type User struct {
	...
	Username          string               `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"` // 1 is field number, it will be used to uniquely identify the field when serialize/deserialize the message in binary format
